(function($) {
     ...
     */
     performBridgeRequestDataTable = function(){
        var configObj = this;
        configObj.before();
     ...
     */
    performBridgeRequestSingle = function(){
        var configObj = this;
        configObj.before();
        //Retrieve and set the Bridge parameter values using JQuery
        var parameters = {};
     ...
     */
    performBridgeRequestList = function(){
        var configObj = this;
        configObj.before();
        //Retrieve and set the Bridge parameter values using JQuery
        var parameters = {};
     ...
     */
    filtersearchConfigByName = function(obj) {
        var configName;
        $.each(search.searchConfig, function(i, config){
            if(config==obj){
               configName=i;
